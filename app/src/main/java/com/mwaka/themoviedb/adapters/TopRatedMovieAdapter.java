...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.MovieViewHolder> {
    ...
    public TopRatedMovieAdapter(List<TopRated> movies, int rowLayout, Context context) {
        this.movies = movies;
    ...
    @Override
    public TopRatedMovieAdapter.MovieViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
